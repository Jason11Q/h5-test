  ...
  function A(e) {
    ...
    if ((o.originalEvent && (o = o.originalEvent), i.isTouched)) {
      if (!i.isTouchEvent || 'touchmove' === o.type) {
        ...
        if (!a.allowTouchMove)
          return (a.allowClick = !1), void (i.isTouched && (S(n, { startX: p, startY: u, currentX: p, currentY: u }), (i.touchStartTime = x())));
          ...
          if (!(a.params.threshold && Math.sqrt(Math.pow(c, 2) + Math.pow(h, 2)) < a.params.threshold)) {
            ...
            if (void 0 === i.isScrolling)
              (a.isHorizontal() && n.currentY === n.startY) || (a.isVertical() && n.currentX === n.startX)
                ? (i.isScrolling = !1)
                : c * c + h * h >= 25 &&
                  ((v = (180 * Math.atan2(Math.abs(h), Math.abs(c))) / Math.PI), (i.isScrolling = a.isHorizontal() ? v > s.touchAngle : 90 - v > s.touchAngle));
            if (
        ...
        if (i.freeModeMomentum) {
          ...
          if (w < t.maxTranslate())
            i.freeModeMomentumBounce
              ? (w + t.maxTranslate() < -S && (w = t.maxTranslate() - S), (b = t.maxTranslate()), (C = !0), (a.allowMomentumBounce = !0))
              : (w = t.maxTranslate()),
              i.loop && i.centeredSlides && (T = !0);
          else if (w > t.minTranslate())
            i.freeModeMomentumBounce
              ? (w - t.minTranslate() > S && (w = t.minTranslate() + S), (b = t.minTranslate()), (C = !0), (a.allowMomentumBounce = !0))
              : (w = t.minTranslate()),
              i.loop && i.centeredSlides && (T = !0);
            ...
            for (var z, P = a.slidesPerColumn, k = C / P, L = Math.floor(u / a.slidesPerColumn), $ = 0; $ < u; $ += 1) {
              ...
              if ('none' !== I.css('display')) {
                if ('auto' === a.slidesPerView) {
                  ...
                  if ((X && (I[0].style.transform = 'none'), Y && (I[0].style.webkitTransform = 'none'), a.roundLengths))
            ...
            if (o && e.currentBreakpoint !== o) {
              ...
              d &&
                ['slidesPerView', 'spaceBetween', 'slidesPerGroup', 'slidesPerGroupSkip', 'slidesPerColumn'].forEach(function (e) {
                  var t = d[e];
                  void 0 !== t &&
                    (d[e] = 'slidesPerView' !== e || ('AUTO' !== t && 'auto' !== t) ? ('slidesPerView' === e ? parseFloat(t) : parseInt(t, 10)) : 'auto');
                });
      ...
      classes: {
        addClasses: function () {
          ...
          l.push('initialized'),
            ...
            i && l.push('rtl'),
            a.slidesPerColumn > 1 && (l.push('multirow'), 'column' === a.slidesPerColumnFill && l.push('multirow-column')),
  ...
  var U = {
    ...
    Z = {
      update: function () {
        ...
        if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
          ...
          if (
            ('fraction' === a.type &&
              (r.find('.' + a.currentClass).text(a.formatFractionCurrent(i + 1)), r.find('.' + a.totalClass).text(a.formatFractionTotal(n))),
            'progressbar' === a.type)
          ) {
            var E;
      ...
      in: function (e) {
        ...
        (x.$slideEl ||
          (y.params.virtual && y.params.virtual.enabled && y.virtual
            ? (x.$slideEl = y.$wrapperEl.children('.' + y.params.slideActiveClass))
      ...
      load: function () {
        ...
        if (n.loadPrevNext)
          if (l > 1 || (n.loadPrevNextAmount && n.loadPrevNextAmount > 1)) {
            for (
              var u = n.loadPrevNextAmount, c = l, h = Math.min(s + c + Math.max(u, c), i.length), v = Math.max(s - Math.max(c, u), 0), f = s + l;
              f < h;
              f += 1
            )
    ...
    ae = {
      ...
      getInterpolateFunction: function (e) {
        var t = this;
        t.controller.spline ||
          (t.controller.spline = t.params.loop ? new ae.LinearSpline(t.slidesGrid, e.slidesGrid) : new ae.LinearSpline(t.snapGrid, e.snapGrid));
      },
      setTranslate: function (e, t) {
        var a,
          i,
    ...
    ce = [
      ...
      },
      {
        ...
        create: function () {
          M(this, {
            a11y: t({}, ie, { liveRegion: m('<span class="' + this.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>') }),
          });
        },
        on: {
