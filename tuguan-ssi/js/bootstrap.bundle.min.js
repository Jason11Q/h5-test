...
!(function (t, e) {
  ...
  var B = {
      ...
      trigger: function (t, e, n) {
        ...
        return (
          s &&
            o &&
            ((i = o.Event(e, n)), o(t).trigger(i), (l = !i.isPropagationStopped()), (c = !i.isImmediatePropagationStopped()), (u = i.isDefaultPrevented())),
  ...
  var z = {
    ...
    $ = (function (t) {
      ...
      return (
        ...
        (r.pause = function (t) {
          t || (this._isPaused = !0),
            Y('.carousel-item-next, .carousel-item-prev', this._element) && (f(this._element), this.cycle(!0)),
          ...
          if (r && r.classList.contains('active')) this._isSliding = !1;
            ...
            if (
              ...
              i.classList.remove('active'),
                r.classList.add('active'),
                (this._isSliding = !1),
                B.trigger(this._element, 'slid.bs.carousel', { relatedTarget: r, direction: f, from: o, to: s });
            a && this.cycle();
          }
        }),
  ...
  B.on(document, 'click.bs.collapse.data-api', '[data-bs-toggle="collapse"]', function (t) {
    ...
    F(n).forEach(function (t) {
      var n,
        i = T(t, 'bs.collapse');
      i ? (null === i._parent && 'string' == typeof e.parent && ((i._config.parent = e.parent), (i._parent = i._getParent())), (n = 'toggle')) : (n = e),
      ...
      fn: function (t) {
        ...
        null != e.modifiersData.popperOffsets &&
          (e.styles.popper = Object.assign(
            ...
            Dt(Object.assign(Object.assign({}, c), {}, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s, roundOffsets: l }))
          )),
          null != e.modifiersData.arrow &&
            (e.styles.arrow = Object.assign(
              Object.assign({}, e.styles.arrow),
              Dt(Object.assign(Object.assign({}, c), {}, { offsets: e.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: l }))
            )),
      ...
      ? Kt(
          (function (t) {
            var e = ct(t),
              ...
              a = 0;
            return (
              i && ((o = i.width), (r = i.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((s = i.offsetLeft), (a = i.offsetTop))),
        ...
        for (
          var o = n.mainAxis,
            ...
            b = [m].concat(_).reduce(function (t, n) {
              return t.concat(
                'auto' === ht(n) ? qt(e, { placement: n, boundary: u, rootBoundary: f, padding: c, flipVariations: p, allowedAutoPlacements: g }) : n
              );
            }, []),
            y = e.rects.reference,
            w = e.rects.popper,
  ...
  function te(t, e, n) {
    ...
    return (
      (a || (!a && !n)) &&
        (('body' !== lt(e) || Rt(r)) && (l = (i = e) !== ct(i) && ft(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : Bt(i)),
        ...
        u = {
          ...
          setOptions: function (n) {
            f(),
              ...
              (a.scrollParents = { reference: ut(t) ? Wt(t) : t.contextElement ? Wt(t.contextElement) : [], popper: Wt(e) });
            var o,
              s,
              c = (function (t) {
                var e = (function (t) {
                  ...
                  return (
                    (t[e.name] = n
                      ? Object.assign(
                          ...
                          {},
                          { options: Object.assign(Object.assign({}, n.options), e.options), data: Object.assign(Object.assign({}, n.data), e.data) }
                        )
                      : e),
                    t
                  );
            ...
            for (var e = F('[data-bs-toggle="dropdown"]'), n = 0, i = e.length; n < i; n++) {
              ...
              if ((t && 'click' === t.type && (r.clickEvent = t), o)) {
                ...
                if (
                  ...
                  !(
                    (t &&
                      (('click' === t.type && /input|textarea/i.test(t.target.tagName)) || ('keyup' === t.type && 'Tab' === t.key)) &&
                      a.contains(t.target)) ||
          ...
          if (null !== t)
            return 'object' == typeof e && d(e)
              ...
              : void (this.config.html
                  ? (this.config.sanitize && (e = ke(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e))
                  : (t.textContent = e));
        }),
        (r.getTitle = function () {
  ...
  return (
    y('toast', ze), { Alert: R, Button: W, Carousel: $, Collapse: J, Dropdown: ve, Modal: ye, Popover: Me, ScrollSpy: Re, Tab: We, Toast: ze, Tooltip: Se }
  );
});
